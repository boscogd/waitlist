            ...
            <div className="grid md:grid-cols-3 gap-8">
              <AnimateOnScroll delay={100}>
                <div className="bg-white rounded-2xl p-6 border border-azul/5 shadow-sm space-y-4">
                  ...
                  <p className="text-texto/80 text-sm leading-relaxed italic">
                    &ldquo;El rosario guiado me ha ayudado a mantener una rutina de oraci&oacute;n que antes no ten&iacute;a. Es como tener un compa&ntilde;ero espiritual siempre disponible.&rdquo;
                  </p>
              ...
              <AnimateOnScroll delay={200}>
                <div className="bg-white rounded-2xl p-6 border border-azul/5 shadow-sm space-y-4">
                  ...
                  <p className="text-texto/80 text-sm leading-relaxed italic">
                    &ldquo;Lo que m&aacute;s me gusta es el Evangelio comentado cada d&iacute;a. Me ayuda a empezar la ma&ntilde;ana con una reflexi&oacute;n que se queda conmigo todo el d&iacute;a.&rdquo;
                  </p>
                  <div className="flex items-center gap-3 pt-2">
                    <div className="w-10 h-10 bg-gradient-to-br from-albero/30 to-dorado/30 rounded-full flex items-center justify-center text-azul font-semibold text-sm">
                      J
              ...
              <AnimateOnScroll delay={300}>
                <div className="bg-white rounded-2xl p-6 border border-azul/5 shadow-sm space-y-4">
                  ...
                  <p className="text-texto/80 text-sm leading-relaxed italic">
                    &ldquo;El compa&ntilde;ero de fe es incre&iacute;ble. Puedo preguntar cualquier duda y me responde con citas del Catecismo. Muy &uacute;til para entender mejor mi fe.&rdquo;
                  </p>
                  <div className="flex items-center gap-3 pt-2">
                    <div className="w-10 h-10 bg-gradient-to-br from-albero/30 to-dorado/30 rounded-full flex items-center justify-center text-azul font-semibold text-sm">
                      A
