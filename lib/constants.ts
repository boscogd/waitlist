...
export const SITE_URL = 'https://refugioenlapalabra.com';

/** URL de la app (Netlify) donde se accede/instala el producto. */
export const APP_URL = 'https://refugio-en-la-palabra.netlify.app';
